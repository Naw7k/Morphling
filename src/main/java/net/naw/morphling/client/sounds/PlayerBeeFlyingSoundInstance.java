...
public class PlayerBeeFlyingSoundInstance extends AbstractTickableSoundInstance {

    private final Player player;

    public PlayerBeeFlyingSoundInstance(Player player) {
